...
ManualBarrier = {}
ManualBarrier.version = "1.9.0.1"
ManualBarrier.date = "08.12.2019"
	...
	if g_currentMission ~= nil then
			...
			if vehicle ~= nil then
				...
				if self:getFieldOwnership() then
					if onEnter and self.isEnabled then
						self.count = self.count + 1
						if vehicle:getIsControlled() ~= nil and self.manualOpen and pName ~= nil and pName == vehicle:getControllerName() then
							self.playerInTrigger = true
						end
					elseif onLeave then
						self.count = self.count - 1
